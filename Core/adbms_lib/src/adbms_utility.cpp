...
//// BASED ON 2950 utility.c and 6830 GenericType.c
//// spiWriteBytes(CMD_LEN, &cmd[0]); parameter is flipped for 2950 same goes for spiReadBytes
//// in spiWriteData 2950 sends true but 6830 false -> data_pec = (uint16_t)pec10_calc(true,BYTES_IN_REG, &copyArray[0]);
...
{
  using namespace AD68_NS; // TODO: FIX - THIS IS SUPPOSED TO BE COMPATIBLE WITH BOTH
