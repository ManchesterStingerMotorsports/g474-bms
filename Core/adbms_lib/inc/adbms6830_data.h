...
namespace AD68_NS
{
  constexpr int CELL = 16;                 /* Bms ic number of cell              */
  constexpr int AUX  = 12;                 /* Bms ic number of Aux               */
  constexpr int RAUX = 10;                 /* Bms ic number of RAux              */
  constexpr int PWMA = 12;                 /* Bms ic number of PWMA              */
  constexpr int PWMB = 4;                  /* Bms ic number of PWMB              */
  constexpr int COMM = 3;                  /* GPIO communication comm reg        */
  ...
  constexpr int RDCVALL_SIZE    = 34;      /* RDCVALL data byte size             */
  constexpr int RDSALL_SIZE     = 34;      /* RDSALL data byte size              */
  constexpr int RDACALL_SIZE    = 34;      /* RDACALL data byte size             */
  constexpr int RDFCALL_SIZE    = 34;      /* RDFCALL data byte size             */
  constexpr int RDCSALL_SIZE    = 66;      /* RDCSALL data byte size             */
  constexpr int RDASALL_SIZE    = 70;      /* RDASALL data byte size             */
  constexpr int RDACSALL_SIZE   = 66;      /* RDACSALL data byte size            */
